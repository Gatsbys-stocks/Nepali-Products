...
let lang = "en"; // "en" or "np" — toggled by the EN/NP buttons, no reload

const I18N = {
  en: {
    eyebrowText: "C/ Industria 124 · Near Sagrada Família · Barcelona 08025",
    heroSub: "Nepali flours, pickles (achar), spices, lentils, noodles and tea brought directly from Nepal. Place your order and we'll deliver it to your door, anywhere in Barcelona or across Europe.",
    shopLabel: "Shop:",
    whatsappLabel: "WhatsApp:",
    waBtnText: "Message us on WhatsApp",
    searchPlaceholder: "Search a product (e.g. achar, chiura, masala...)",
    catAll: "All",
    photoCredit: "Illustrative photos, not the exact product — Wikimedia Commons, CC licenses / public domain (credit shown on hover over each photo).",
    packLabel: "Pack:",
    addBtn: "Add",
    removeUnitAria: "Remove one unit",
    addUnitAria: "Add one unit",
    noMatch: "No products match your search.",
    noteStrip: "<b>Delivery:</b> we deliver to Barcelona and to other cities across Europe and worldwide. When you confirm your order you'll get real-time rates from our carriers (UPS, DHL, DHL eCommerce, FedEx) based on your address, choose one, and place your order directly — no WhatsApp needed. We'll follow up by email to arrange payment.",
    footerText: "Buddhabhumi Pvt. Li. — Barcelona, Spain",
    cartFabLabel: "Cart",
    ...
    modalHint: "Fill in your details, get live carrier rates, and confirm — your order goes straight to us, no WhatsApp step required.",
    labelName: "Full name",
    ...
    shipNote: "Live rates from your connected carriers (UPS, DHL, DHL eCommerce, FedEx...) via Shippo.",
  ...
  np: {
    eyebrowText: "C/ Industria 124 · Sagrada Família नजिक · Barcelona 08025",
    heroSub: "नेपालबाट सिधै ल्याइएको पिठो, अचार, मसला, दाल, चाउचाउ र चिया। आफ्नो अर्डर गर्नुहोस्, हामी बार्सिलोना वा युरोपभर तपाईंको ढोकासम्म पुर्‍याउनेछौं।",
    shopLabel: "पसल:",
    whatsappLabel: "ह्वाट्सएप:",
    waBtnText: "ह्वाट्सएपमा सन्देश पठाउनुहोस्",
    searchPlaceholder: "उत्पादन खोज्नुहोस् (जस्तै achar, chiura, masala...)",
    catAll: "सबै",
    photoCredit: "उदाहरणका लागि फोटो, ठ्याक्कै उही उत्पादन नभएको हुन सक्छ — Wikimedia Commons, CC लाइसेन्स / सार्वजनिक डोमेन (क्रेडिट प्रत्येक फोटोमा होभर गर्दा देखिन्छ)।",
    packLabel: "प्याक:",
    addBtn: "थप्नुहोस्",
    removeUnitAria: "एक थान हटाउनुहोस्",
    addUnitAria: "एक थान थप्नुहोस्",
    noMatch: "तपाईंको खोजसँग मिल्ने उत्पादन फेला परेन।",
    noteStrip: "<b>डेलिभरी:</b> हामी बार्सिलोना र युरोपका अन्य शहरहरू साथै विश्वभर डेलिभरी गर्छौं। अर्डर पुष्टि गर्दा तपाईंले हाम्रा ढुवानी कम्पनीहरू (UPS, DHL, DHL eCommerce, FedEx) बाट तपाईंको ठेगानाअनुसार वास्तविक-समयको दर पाउनुहुनेछ, एउटा छान्नुहोस्, र सिधै अर्डर राख्नुहोस् — ह्वाट्सएप चाहिँदैन। भुक्तानी मिलाउन हामी पछि इमेल गर्नेछौं।",
    footerText: "बुद्धभूमि प्रा.लि. — बार्सिलोना, स्पेन",
    cartFabLabel: "कार्ट",
    ...
    emptyCart: "तपाईंको कार्ट खाली छ। सूचीबाट उत्पादनहरू थप्नुहोस्।",
    removeBtn: "हटाउनुहोस्",
    modalTitle: "अर्डर पुष्टि गर्नुहोस्",
    modalHint: "आफ्नो विवरण भर्नुहोस्, ढुवानी दर हेर्नुहोस्, र पुष्टि गर्नुहोस् — तपाईंको अर्डर सिधै हामीलाई जान्छ, ह्वाट्सएप आवश्यक पर्दैन।",
    labelName: "पूरा नाम",
    ...
    otherCountryMsg: "यो सूचीभन्दा बाहिरका गन्तव्यका लागि, कृपया हामीलाई ह्वाट्सएपमा सन्देश पठाउनुहोस् ताकि हामी म्यानुअल रूपमा दर दिन सकौं।",
    ...
    shipNote: "Shippo मार्फत तपाईंका जोडिएका ढुवानी कम्पनीहरू (UPS, DHL, DHL eCommerce, FedEx...) बाट प्रत्यक्ष दर।",
    labelNotes: "टिप्पणी (वैकल्पिक)",
    notesPlaceholder: "डेलिभरी प्राथमिकता, समय, आदि।",
    sumProductsLabel: "उत्पादनहरू",
    ...
    paymentCancelledBanner: (id) => `अर्डर ${id} को भुक्तानी रद्द भयो। तपाईं कार्टबाट फेरि प्रयास गर्न सक्नुहुन्छ, वा ह्वाट्सएपमा हामीलाई सम्पर्क गर्नुहोस्।`,
...
const CATEGORIES = [
  {id:"pitho", es:"Flours & grains", np:"पिठो / अन्न"},
  {id:"achar", es:"Pickles (achar)", np:"अचार"},
  {id:"noodles", es:"Noodles & snacks", np:"चाउचाउ"},
  {id:"daal", es:"Lentils & beans", np:"दाल / सिमी"},
  {id:"masala", es:"Spices & masala", np:"मसला"},
  {id:"chiya", es:"Tea & drinks", np:"चिया / जुस"},
  {id:"otros", es:"Other", np:"अन्य"}
];
...
function renderCatButtons(){
  ...
  const all = [{id:"all",es:"All",np:"सबै"}, ...CATEGORIES];
  el.innerHTML = all.map(c =>
    `<button class="cat-btn ${activeCat===c.id?'active':''}" data-cat="${c.id}">${lang==='np' ? c.np : c.es}</button>`
  ).join("");
...
function renderCatalog(){
  ...
  let html = "";
  cats.forEach(cat=>{
    const items = PRODUCTS.filter(p => p.cat===cat.id && (q==="" || p.name.toLowerCase().includes(q)));
    if(items.length===0) return;
    const img = CAT_IMAGES[cat.id];
    html += `<h2 class="section-label">${cat.es} <span class="np">${cat.np}</span></h2>`;
        ...
        <div class="card-bottom">
          ...
          ${inCart>0
            ? `<div class="qty-stepper">
                 ...
                 <span>${inCart}</span>
                 <button data-action="inc" data-id="${p.id}" aria-label="${t('addUnitAria')}">+</button>
               </div>`
            : `<button class="add-btn" data-action="add" data-id="${p.id}">${t('addBtn')}</button>`
          }
        </div>
      </div>`;
    });
...
function updateSummary(){
  ...
  document.getElementById("sumProducts").textContent = fmt(cartTotal());
  ...
  document.getElementById("sumTotal").textContent = fmt(cartTotal() + shipPrice);
}
...
document.getElementById("sendOrder").addEventListener("click", async ()=>{
  ...
  try{
    ...
    const data = await res.json();
    if(!res.ok) throw new Error(data.error || t("orderErrorDefault"));
    ...
    orderStatus.style.color = "var(--red)";
    orderStatus.textContent = t("paymentRedirectError") + err.message;
  }finally{
...
document.getElementById("langEnBtn").addEventListener("click", ()=>{
  ...
  document.getElementById("langNpBtn").classList.remove("active");
  applyI18n();
});
document.getElementById("langNpBtn").addEventListener("click", ()=>{
  if(lang==="np") return;
  lang = "np";
  document.getElementById("langNpBtn").classList.add("active");
